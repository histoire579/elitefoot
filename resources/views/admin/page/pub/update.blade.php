...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{route('administration.pub.edit',$pub->id)}}" enctype="multipart/form-data">
                    @csrf
                  
                    <div class="form-group row">
                        <label for="raison_sociale" class="col-md-2 col-form-label">Raison sociale</label>
                        <div class="col-md-10">
                            
                            <input class=" form-control" id="raison_sociale" name="raison_sociale" type="text" value="{{$pub->raison_sociale}}" required />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="site" class="col-md-2 col-form-label">Site (url)</label>
                        <div class="col-md-10">
                            <input class=" form-control" id="site" name="site" value="{{$pub->site}}" type="url" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class=" form-control" id="debut" name="debut" type="date" value="{{$pub->debut}}" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class=" form-control" id="debut" name="fin" type="date" value="{{$pub->fin}}" required />
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;border: 1px solid #ddd; border-radius: 4px;">
                                  ...
                                  <img src="{{asset('/storage/imgs/'.$pub->image)}}" alt="" />
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="/administration/pub" type="button" class="btn btn-outline-danger waves-effect waves-light mt-3"> Annuler</a>
                        </div>
                    </div>
