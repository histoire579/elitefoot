...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{route('administration.actualite.edit',$actualite->id)}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="titre"  id="titre" value="{{$actualite->titre}}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="titre_en" class="col-md-2 col-form-label">Titre_en</label>
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="titre_en"  id="titre_en" value="{{$actualite->titre_en}}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea  class="form-control" rows="5" id="short" name="short">{{$actualite->short}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea  class="form-control" rows="5" id="short_en" name="short_en">{{$actualite->short_en}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea  class="form-control" rows="5" id="elm1" name="message">{{$actualite->message}}</textarea>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="message_en" class="col-md-2 col-form-label">Description</label>
                        <div class="col-md-10">
                            <textarea  class="form-control" rows="5" id="elm2" name="message_en">{{$actualite->message_en}}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;border: 1px solid #ddd; border-radius: 4px;">
                                  ...
                                  <img src="{{asset('/storage/imgs/'.$actualite->photo)}}" alt="" />
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="/administration/actualite" type="button" class="btn btn-outline-danger waves-effect waves-light mt-3"> Annuler</a>
                        </div>
                    </div>
