...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{route('administration.journee.edit',$journee->id)}}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label for="libelle" class="col-md-2 col-form-label">Libelle</label>
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="libelle"  id="libelle" value="{{$journee->libelle}}">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="libelle" class="col-md-2 col-form-label">Libelle_en</label>
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="libelle_en"  id="libelle_en" value="{{$journee->libelle}}">
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            <select class="form-control" name="saison_id" id="saison_id">
                                @foreach ($saisons as $saison)
                                    @if ($saison->id ==$journee->saison_id)
