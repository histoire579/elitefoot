...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{route('administration.stade.edit',$stade->id)}}" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="form-group row">
                        <label for="nom" class="col-md-2 col-form-label">Nom</label>
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="nom"  id="nom" value="{{$stade->nom}}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="lieu" class="col-md-2 col-form-label">Lieu</label>
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="lieu"  id="lieu" value="{{$stade->lieu}}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" name="capacite"  id="capacite" value="{{$stade->capacite}}" required>
                        </div>
                    </div>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;border: 1px solid #ddd; border-radius: 4px;">
                                  ...
                                  <img src="{{asset('/storage/imgs/'.$stade->photo)}}" alt="" />
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="/administration/stade" type="button" class="btn btn-outline-danger waves-effect waves-light mt-3"> Annuler</a>
                        </div>
                    </div>
