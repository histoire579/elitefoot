        ...
        <div class="col-lg-7 col-xl-6 col-xxl-5 mx-auto mt-n20">
          <div class="card">
            <div class="card-body p-11 text-center">
              ...
              <p class="lead mb-6 text-start">{{ __('Please confirm your password before continuing.') }}</p>
              <form class="text-start mb-3" method="POST" action="{{ route('password.confirm') }}">
                @csrf
                ...
                <button type="submit" class="btn btn-primary rounded-pill btn-login w-100 mb-2">{{ __('Confirm Password') }}</button>
